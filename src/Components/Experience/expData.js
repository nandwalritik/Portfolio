const dataMap = [
    ...
    },
    {
        ...
        Company: "Techoopers Pvt. Ltd.",
        Position: "Software Developer Trainee",
        description: [
            "During my internship I worked on ReactJS,MongoDB,NodeJS and Express.",
            "Made an application using ReactJS,API using NodeJS and a NoSQL database in MongoDB.",
            "Applied Server Side Rendering and Material UI to my application."
        ]
    }
];
